...
import com.simple.demo.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Timer, String> ApplicationConversionServiceFactoryBean.getTimerToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.simple.demo.domain.Timer, java.lang.String>() {
    ...
    public Converter<Long, Timer> ApplicationConversionServiceFactoryBean.getIdToTimerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.simple.demo.domain.Timer>() {
            public com.simple.demo.domain.Timer convert(java.lang.Long id) {
    ...
    public Converter<String, Timer> ApplicationConversionServiceFactoryBean.getStringToTimerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.simple.demo.domain.Timer>() {
            public com.simple.demo.domain.Timer convert(String id) {
